...
- [**Managing Groups** 🐧](#managing-groups-)
  ...
  - [📌 Introduction to Linux Groups](#-introduction-to-linux-groups)
    - [📂 Types of Groups](#-types-of-groups)
  - [🚧 Managing Linux Groups](#-managing-linux-groups)
    - [🔨 Creating a Group](#-creating-a-group)
      - [Basic Syntax:](#basic-syntax)
      - [Example:](#example)
      - [Checking Group Information:](#checking-group-information)
      - [Output Explanation:](#output-explanation)
    - [🎯 Creating a Group with Specific GID](#-creating-a-group-with-specific-gid)
    - [📖 Documentation:](#-documentation)
  - [📁 Files for Group Information](#-files-for-group-information)
  - [⚙️ Commands Explained with Outputs](#️-commands-explained-with-outputs)
    - [Command:](#command)
      - [Output:](#output)
    - [Verifying Group Entries:](#verifying-group-entries)
      - [Checking last 3 groups in `/etc/group`:](#checking-last-3-groups-in-etcgroup)
      - [Example output:](#example-output)
      - [Checking last 3 groups in `/etc/gshadow`:](#checking-last-3-groups-in-etcgshadow)
      - [Example output:](#example-output-1)
    - [🔐 **Understanding Group Passwords**](#-understanding-group-passwords)
  - [⚙️ **Modifying Groups**](#️-modifying-groups)
  - [🗑️ **Deleting Groups**](#️-deleting-groups)
  - [✏️ **Modifying Groups via `/etc/group`**](#️-modifying-groups-via-etcgroup)
  - [👥 **Managing Users in Groups**](#-managing-users-in-groups)
    - [✅ **Adding Users to Groups**](#-adding-users-to-groups)
    - [🚚 **Moving and Removing Users Across Groups**](#-moving-and-removing-users-across-groups)
- [**Viewing Groups** 📘](#viewing-groups-)
  - [📂 Group Information Files](#-group-information-files)
  - [🔍 View All Groups](#-view-all-groups)
    - [✅ Step 1: Update and Install Utilities](#-step-1-update-and-install-utilities)
    - [🧾 Step 2: List All Group Names](#-step-2-list-all-group-names)
  - [📋 Using `getent` to View Groups](#-using-getent-to-view-groups)
    - [🔍 View Specific Group Details](#-view-specific-group-details)
  - [👤 View a User's Group Memberships](#-view-a-users-group-memberships)
    - [🔎 Groups of a Specific User](#-groups-of-a-specific-user)
    - [🙋‍♂️ Groups of Current User](#️-groups-of-current-user)
  - [🔄 Group Login Sessions](#-group-login-sessions)
    - [🧠 Concept](#-concept)
  - [🔑 Switching Group Sessions: `newgrp`](#-switching-group-sessions-newgrp)
    - [🔁 Syntax](#-syntax)
  - [🧪 Example: Simulating alex2](#-example-simulating-alex2)
    - [🔧 Step 1: Check `alex2`'s Group Info](#-step-1-check-alex2s-group-info)
    - [👤 Step 2: Switch to User `alex2`](#-step-2-switch-to-user-alex2)
    - [✅ Confirm Identity](#-confirm-identity)
    - [📋 Show All Group IDs and Names](#-show-all-group-ids-and-names)
    - [🔍 Show Current Primary Group ID](#-show-current-primary-group-id)
    - [🔄 Change to Group `developers`](#-change-to-group-developers)
  - [🚫 Accessing Unauthorized Groups](#-accessing-unauthorized-groups)
