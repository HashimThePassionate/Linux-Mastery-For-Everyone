...
- [🐧 **UNIX Versus LINUX**](#-unix-versus-linux)
  - [🐚 Available Shell Types](#-available-shell-types)
    - [The C Shell Branch](#the-c-shell-branch)
    - [Shell Categories](#shell-categories)
    - [📖 Note on This section's Examples](#-note-on-this-sections-examples)
- [❓ **What is Bash**?](#-what-is-bash)
  - [Shells on Mac OS X](#shells-on-mac-os-x)
  - [Checking Your Shell Version](#checking-your-shell-version)
  - [🆘 Getting Help for bash Commands](#-getting-help-for-bash-commands)
  - [🧭 Navigating Around Directories](#-navigating-around-directories)
    - [📂 `pwd` (Print Working Directory)](#-pwd-print-working-directory)
    - [➡️ `cd` (Change Directory)](#️-cd-change-directory)
  - [📜 The `history` Command](#-the-history-command)
    - [Re-executing Commands](#re-executing-commands)
  - [📋 Listing Filenames with the `ls` Command](#-listing-filenames-with-the-ls-command)
    - [Default `ls`](#default-ls)
    - [`ls -1` (Vertical Listing)](#ls--1-vertical-listing)
    - [`ls -l` (Long Listing)](#ls--l-long-listing)
    - [`ls -lt` (Time-based Long Listing)](#ls--lt-time-based-long-listing)
    - [`ls -ltr` (Reversed Time-based Long Listing)](#ls--ltr-reversed-time-based-long-listing)
    - [🔍 Understanding the Long Listing (`ls -l`) Columns](#-understanding-the-long-listing-ls--l-columns)
...
- [📄 **Displaying the Contents of Files**](#-displaying-the-contents-of-files)
  ...
  - [⬆️ The `head` and `tail` Commands](#️-the-head-and-tail-commands)
    - [`head`](#head)
    - [`tail`](#tail)
    - [`more` and `less`](#more-and-less)
  - [ቧ The Pipe Symbol](#-the-pipe-symbol)
  - [✂️ The `fold` Command](#️-the-fold-command)
- [🔐 File Ownership: Owner, Group, and World](#-file-ownership-owner-group-and-world)
  - [🛠️ Using the `chmod` Command](#️-using-the-chmod-command)
    - [Setting Absolute Symbolic Permissions](#setting-absolute-symbolic-permissions)
    - [Adding or Removing Permissions](#adding-or-removing-permissions)
  - [🚀 Practical Examples from Scratch](#-practical-examples-from-scratch)
- [📂 **Hidden File Management Concepts**](#-hidden-file-management-concepts)
  - [Ẩ Hidden Files](#-hidden-files)
    - [Listing Hidden Files](#listing-hidden-files)
    - [Special Directory Entries](#special-directory-entries)
  - [⚠️ Handling Problematic Filenames](#️-handling-problematic-filenames)
    - [Files with Whitespaces](#files-with-whitespaces)
    - [Files Starting with a Dash (`-`)](#files-starting-with-a-dash--)
- [🌍 **Working with Environment Variables**](#-working-with-environment-variables)
  - [🖥️ The `env` Command](#️-the-env-command)
    - [📜 Output Explanation](#-output-explanation)
  - [💡 Useful Environment Variables](#-useful-environment-variables)
  - [🔧 Setting the `PATH` Environment Variable](#-setting-the-path-environment-variable)
    - [Examples of Setting the `PATH`](#examples-of-setting-the-path)
  - [🔬 Practical `PATH` Demonstration](#-practical-path-demonstration)
  - [🏷️ Defining Custom Variables](#️-defining-custom-variables)
  - [🚀 Specifying Aliases](#-specifying-aliases)
- [🔎 **Finding Executable Files**](#-finding-executable-files)
  - [`which`](#which)
  - [`whereis`](#whereis)
  - [`whatis`](#whatis)
- [🗣️ **The `printf` Command and The `echo` Command**](#️-the-printf-command-and-the-echo-command)
  - [`printf` Example](#printf-example)
  - [`echo` Example](#echo-example)
- [✂️ **The `cut` Command**](#️-the-cut-command)
  - [Example 1: Extract by Delimiter](#example-1-extract-by-delimiter)
  - [Example 2: Extract by Character Range](#example-2-extract-by-character-range)
- [🚀 Bash Script: Filename Manipulation](#-bash-script-filename-manipulation)
  - [📜 Example 3: cut in a Shell Script](#-example-3-cut-in-a-shell-script)
  - [💻 Detailed Code Explanation](#-detailed-code-explanation)
  - [🚀 How to Create and Run the Script](#-how-to-create-and-run-the-script)
    - [1. Create the Script File](#1-create-the-script-file)
    - [2. Provide Execute Permissions](#2-provide-execute-permissions)
    - [3. Run the Script](#3-run-the-script)
  - [📊 Expected Output](#-expected-output)
- [🗣️ **The `echo` Command and Whitespaces**](#️-the-echo-command-and-whitespaces)
  - [📜 Script: `EchoCut.sh`](#-script-echocutsh)
    - [Script Content](#script-content)
  - [🚀 Execution and Output](#-execution-and-output)
  - [🧐 Detailed Analysis](#-detailed-analysis)
    - [The Problem: Word Splitting](#the-problem-word-splitting)
    - [💡 Why This Is Important](#-why-this-is-important)
- [🚀 **Command Substitution (Backtick)**](#-command-substitution-backtick)
  - [📜 Listing 1.3: `CommandSubst.sh`](#-listing-13-commandsubstsh)
    - [1. Create and Prepare the Script](#1-create-and-prepare-the-script)
  ...
  - [🚀 Execution and Output](#-execution-and-output-1)
    - [📊 Output Explanation](#-output-explanation)
- [ቧ **The Pipe Symbol and Multiple Commands**](#-the-pipe-symbol-and-multiple-commands)
  - [⚠️ Handling Errors in Pipelines](#️-handling-errors-in-pipelines)
  - [Redirecting Multiple Commands](#redirecting-multiple-commands)
    - [Method 1: Grouping with Parentheses `()`](#method-1-grouping-with-parentheses-)
    - [Method 2: Grouping with Curly Braces `{}`](#method-2-grouping-with-curly-braces-)
    - [Output (Verifying File Creation)](#output-verifying-file-creation)
  - [Variable Scope and Pipelines](#variable-scope-and-pipelines)
  - [🖇️ Conditional Execution: The `&&` Operator](#️-conditional-execution-the--operator)
    - [Output](#output)
- [⛓️ **Using a Semicolon to Separate Commands**](#️-using-a-semicolon-to-separate-commands)
  - [Example 1: Direct Execution](#example-1-direct-execution)
  - [Example 2: Command Substitution](#example-2-command-substitution)
- [📋 **The `paste` Command**](#-the-paste-command)
  - [Listing 1.4: `list1` (Input File 1)](#listing-14-list1-input-file-1)
  - [Listing 1.5: `list2` (Input File 2)](#listing-15-list2-input-file-2)
  - [Listing 1.6: `list1.sh` (The `paste` Operation)](#listing-16-list1sh-the-paste-operation)
  - [Executing the `list1.sh` Script](#executing-the-list1sh-script)
- [📄 **Inserting Blank Lines with the `paste` Command**](#-inserting-blank-lines-with-the-paste-command)
  - [1. Insert a Blank Line After Every Line](#1-insert-a-blank-line-after-every-line)
  - [2. Insert a Blank Line After Every Other Line](#2-insert-a-blank-line-after-every-other-line)
  - [3. Insert a Blank Line After Every Third Line](#3-insert-a-blank-line-after-every-third-line)
- [🖇️ **A Simple Use Case with the `paste` Command**](#️-a-simple-use-case-with-the-paste-command)
  - [Listing 1.7: `linepairs.csv`](#listing-17-linepairscsv)
  - [Listing 1.8: `linepairs.sh`](#listing-18-linepairssh)
  - [🚀 Execution and Initial Output](#-execution-and-initial-output)
  - [✅ Fixing the Delimiter with `sed`](#-fixing-the-delimiter-with-sed)
- [🖇️ **A Simple Use Case with `cut` and `paste` Commands**](#️-a-simple-use-case-with-cut-and-paste-commands)
  - [📜 Listing 1.9: `namepairs.csv`](#-listing-19-namepairscsv)
    - [💻 Code Explanation](#-code-explanation)
  - [📜 Listing 1.10: `reversecolums.sh`](#-listing-110-reversecolumssh)
    - [💻 Detailed Code Explanation](#-detailed-code-explanation-2)
  - [🚀 Execution and Output](#-execution-and-output-2)
  - [🧐 Critique and a Better Solution](#-critique-and-a-better-solution)
    - [💻 `awk` Command Explanation](#-awk-command-explanation)
    - [💡 Final Thoughts](#-final-thoughts)
- [🔡 **Working with Character Classes**](#-working-with-character-classes)
  - [Basic Character Sets](#basic-character-sets)
  - [Combinations and Repetition](#combinations-and-repetition)
  - [The Dual Role of the `^` (Caret) Metacharacter](#the-dual-role-of-the--caret-metacharacter)
    - [1. As "Start of Line" (Anchor)](#1-as-start-of-line-anchor)
    - [2. As "Negation" (Inside Brackets)](#2-as-negation-inside-brackets)
  - [Grouping and Alternation (`|`)](#grouping-and-alternation-)
  - [🛡️ The `\` (Backslash) Escape Character](#️-the--backslash-escape-character)
  - [🚫 The `!` (Exclamation Mark) for Negation](#-the--exclamation-mark-for-negation)
- [**Shells: What About Zsh**?](#shells-what-about-zsh)
  - [🆚 Bash and Zsh: A Comparison](#-bash-and-zsh-a-comparison)
    - [Key Differences](#key-differences)
  - [🔄 Switching Between Bash and Zsh](#-switching-between-bash-and-zsh)
    - [Set Zsh as Default](#set-zsh-as-default)
    - [Switch Back to Bash](#switch-back-to-bash)
  - [⚙️ Configuring Zsh](#️-configuring-zsh)
