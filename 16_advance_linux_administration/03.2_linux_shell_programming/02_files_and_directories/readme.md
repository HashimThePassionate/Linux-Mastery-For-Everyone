...
### 📂 File Operations
- [Create, Copy, Remove, and Move Files](#create-copy-remove-and-move-files)
  - [Working with the `cp` (Copy) Command](#-working-with-the-cp-copy-command)
    - [Code Explanation](#-code-explanation)
  - [A Critical Warning: Overwriting Files](#️-a-critical-warning-overwriting-files)
    - [Practical Example (overwriting)](#practical-example-overwriting)
  - [Copying Multiple Files to a Directory](#️-copying-multiple-files-to-a-directory)
    - [Code Explanation](#-code-explanation-1)
  - [Preventing Overwrites with `noclobber`](#️-preventing-overwrites-with-noclobber)
    - [Practical Example (noclobber)](#practical-example-noclobber)
  - [Useful `cp` Switches (Options)](#️-useful-cp-switches-options)
  - [Example: Recursive Copy (`-r`)](#-example-recursive-copy--r)
    - [Practical Example (recursive copy)](#practical-example-recursive-copy)
  - [Copying Files with Command Substitution](#-copying-files-with-command-substitution)
    - [Listing 2.1: The Basic Command](#-listing-21-the-basic-command)
    - [Practical Example (How it Works)](#-practical-example-how-it-works)
    - [Code Explanation](#-code-explanation-2)
  - [The Caveat: This Ignores Directories](#️-the-caveat-this-ignores-directories)
    - [Practical Example (The Failure)](#-practical-example-the-failure)
  - [Flawed Attempts to Fix This](#-flawed-attempts-to-fix-this)
  - [The Correct Way to Copy Directories](#-the-correct-way-to-copy-directories)
    - [Solution A: Copy the Entire Directory](#️-solution-a-copy-the-entire-directory)
    - [Solution B: Copy Only the Directory's Contents](#️-solution-b-copy-only-the-directorys-contents)

### 🗑️ File Deletion
- [Deleting Files with the `rm` Command](#️-deleting-files-with-the-rm-command)
  - [Basic File Deletion](#basic-file-deletion)
    - [Practical Example](#-practical-example)
  - [Useful `rm` Options](#️-useful-rm-options)
    - [Practical Example (`-i` Interactive Mode)](#-practical-example--i-interactive-mode)
    - [Practical Example (`-r` Recursive Mode)](#-practical-example--r-recursive-mode)
  - [The DANGEROUS Command: `rm -rf *`](#️-the-dangerous-command-rm--rf-)
    - [A *Safe* Practical Example (Using a Sandbox)](#-a-safe-practical-example-using-a-sandbox)
  - [Best Practice: Preview with `ls` First](#-best-practice-preview-with-ls-first)
    - [Practical Example](#-practical-example-1)
  - [Deleting Files from a List](#-deleting-files-from-a-list)
    - [Practical Example](#-practical-example-2)
  - [A Safer Alternative: Backing Up Files](#-a-safer-alternative-backing-up-files)
    - [Practical Example](#-practical-example-3)

### 📦 Moving Files
- [Moving Files with the `mv` Command](#-moving-files-with-the-mv-command)
  - [Example 1: Renaming a File](#️-example-1-renaming-a-file)
    - [Practical Example](#-practical-example-4)
    - [Code Explanation](#-code-explanation-3)
  - [Example 2: Moving Files to a Directory](#️-example-2-moving-files-to-a-directory)
    - [Practical Example](#-practical-example-5)
    - [Code Explanation](#-code-explanation-4)
  - [Example 3: Moving a Directory](#️-example-3-moving-a-directory)
    - [Practical Example](#-practical-example-6)
    - [Code Explanation](#-code-explanation-5)

### 🔗 Links
- [The `ln` (Link) Command](#-the-ln-link-command)
  - [Practical Example: Creating and Using a Symlink](#-practical-example-creating-and-using-a-symlink)
    - [1. Create the Original File](#1-create-the-original-file)
    - [2. Create the Symbolic Link](#2-create-the-symbolic-link)
    - [3. Check the Link and File Listing](#3-check-the-link-and-file-listing)
    - [4. Test the "Source of Truth" Concept](#4-test-the-source-of-truth-concept)
    - [5. Deleting the Link (Safe)](#5-deleting-the-link-safe)
    - [6. Adding New Text in doc2 Will Reflect in Original File](#6-adding-new-text-in-doc2-will-reflect-in-original-file)
    - [7. Deleting the Original File (Breaking the Link)](#7-deleting-the-original-file-breaking-the-link)

### 📇 File Information Commands
- [The `basename`, `dirname`, and `file` Commands](#-the-basename-dirname-and-file-commands)
  - [Practical Example 1: `basename` (Simple)](#-practical-example-1-basename-simple)
  - [Practical Example 2: `basename` with Spaces (The Wrong Way)](#-practical-example-2-basename-with-spaces-the-wrong-way)
  - [Practical Example 3: `basename` with Spaces (The Correct Way)](#-practical-example-3-basename-with-spaces-the-correct-way)
  - [Practical Example 4: `dirname`](#-practical-example-4-dirname)
  - [Practical Example 5: `file`](#-practical-example-5-file)

### 📊 Counting and Viewing
- [The `wc` Command](#-the-wc-command)
  - [Practical Example 1: Counting in Multiple Files](#-practical-example-1-counting-in-multiple-files)
  - [Practical Example 2: Counting Files in a Directory](#-practical-example-2-counting-files-in-a-directory)
- [The `cat` Command](#-the-cat-command)
  - [Practical Example](#-practical-example-7)
- [The `more` and `less` Commands](#-the-more-and-less-commands)
  - [Practical Example 1: Basic Usage](#-practical-example-1-basic-usage)
  - [Practical Example 2: Inefficient Usage](#-practical-example-2-inefficient-usage)
  - [Practical Example 3: `more` Options](#-practical-example-3-more-options)
- [The `head` Command](#️-the-head-command)
  - [Practical Example 1: Basic Usage](#-practical-example-1-basic-usage-1)
  - [Practical Example 2: `head` on Multiple Files](#-practical-example-2-head-on-multiple-files)
  - [Practical Example 3: `head` in a Script](#-practical-example-3-head-in-a-script)
  - [Practical Example 4: `head` with `wc`](#-practical-example-4-head-with-wc)
  - [Practical Example 5: `head` with Numbered Lines](#-practical-example-5-head-with-numbered-lines)
- [The `tail` Command](#️-the-tail-command)
  - [Practical Example 1: Basic Usage](#-practical-example-1-basic-usage-2)
  - [Practical Example 2: `tail` on Multiple Files](#-practical-example-2-tail-on-multiple-files)
  - [Practical Example 3: `tail` in a Script](#-practical-example-3-tail-in-a-script)
  - [Practical Example 4: `tail` with `wc`](#-practical-example-4-tail-with-wc)
  - [Practical Example 5: `tail -f` (Follow)](#-practical-example-5-tail--f-follow)

### 🔍 Comparing Files
- [Comparing File Contents](#-comparing-file-contents)
  - [`cmp` (Compare) Command](#cmp-compare-command)
    - [Practical Example from Scratch](#-practical-example-from-scratch)
  - [`diff` (Difference) Command](#diff-difference-command)
    - [Practical Example from Scratch](#-practical-example-from-scratch-1)
  - [`comm` (Common) Command](#comm-common-command)
    - [Practical Example from Scratch](#-practical-example-from-scratch-2)

### 🧩 File Name Parts
- [The Parts of a Filename](#-the-parts-of-a-filename)
  - [`basename` and `dirname`](#basename-and-dirname)
    - [Practical Example from Scratch](#-practical-example-from-scratch-3)
  - [The `strings` Command](#-the-strings-command)
    - [Practical Example from Scratch](#-practical-example-from-scratch-4)

### 🔐 File Permissions
- [Working with File Permissions](#-working-with-file-permissions)
  - [File Permissions Explained](#file-permissions-explained)
  - [Permissions in Octal (Numeric) Mode](#permissions-in-octal-numeric-mode)
  - [Changing Permissions with `chmod`](#changing-permissions-with-chmod)
    - [Practical Example: Symbolic Mode (`+x`, `u+x`)](#-practical-example-symbolic-mode-x-ux)
    - [Practical Example: Octal Mode (`644`, `444`)](#-practical-example-octal-mode-644-444)
    - [Practical Example: Directory Permissions (`1777`, `000`)](#-practical-example-directory-permissions-1777-000)
    - [Practical Example: The SUID Bit (`u+s`)](#-practical-example-the-suid-bit-us)
      - [1. Create the C Program](#1-create-the-c-program)
      - [2. Compile the Program](#2-compile-the-program)
      - [3. Test as a Normal User (Expected Failure)](#3-test-as-a-normal-user-expected-failure)
      - [4. Change Owner and Set SUID (as `root`)](#4-change-owner-and-set-suid-as-root)
      - [5. Verify the New Permissions](#5-verify-the-new-permissions)
      - [6. Test as a Normal User (Success!)](#6-test-as-a-normal-user-success)
      - [Why Did It Work?](#-why-did-it-work)
  - [Changing Owner, Permissions, and Groups](#-changing-owner-permissions-and-groups)
    - [Practical Example: `chown` and `chgrp`](#-practical-example-chown-and-chgrp)
  - [The `umask` and `ulimit` Commands](#-the-umask-and-ulimit-commands)
    - [`umask` (User Mask)](#umask-user-mask)
    - [`ulimit` (User Limit)](#ulimit-user-limit)

### 📁 Directory Operations
- [Working with Directories](#-working-with-directories)
  - [The Directory Tree](#-the-directory-tree)
  - [Absolute and Relative Pathnames](#️-absolute-and-relative-pathnames)
  - [Navigating Directories](#-navigating-directories)
    - [Going to the Home Directory](#-going-to-the-home-directory)
    - [Going to Another User's Home](#-going-to-another-users-home)
    - [Going to the Previous Directory](#️-going-to-the-previous-directory)
  - [Listing and Finding Directories](#-listing-and-finding-directories)
    - [`pwd` (Print Working Directory)](#pwd-print-working-directory)
    - [`ls` (List Contents)](#ls-list-contents)
  - [Creating Directories (`mkdir`)](#-creating-directories-mkdir)
    - [Creating Single or Multiple Directories](#creating-single-or-multiple-directories)
    - [Creating Nested Directories (`mkdir -p`)](#creating-nested-directories-mkdir--p)
  - [Removing Directories](#-removing-directories)
    - [`rmdir` (Remove *Empty* Directories)](#rmdir-remove-empty-directories)
    - [`rm -r` (Remove *Non-Empty* Directories)](#rm--r-remove-non-empty-directories)
  - [Moving and Renaming Directories (`mv`)](#-moving-and-renaming-directories-mv)
    - [Renaming a Directory](#renaming-a-directory)
    - [Moving a Directory](#moving-a-directory)
    - [The "noclobber" Safety Feature](#the-noclobber-safety-feature)

### 💬 Shell Features
- [Using Quote Characters](#-using-quote-characters)
  - [Single Quotes (`'`)](#-single-quotes-)
    - [Practical Example from Scratch](#-practical-example-from-scratch-5)
  - [Double Quotes (`"`)](#-double-quotes-)
    - [Practical Example from Scratch](#-practical-example-from-scratch-6)
  - [\` (Backquotes)](#-backquotes)
    - [Modern Alternative: `$(...)`](#-modern-alternative-)
    - [Practical Example from Scratch](#-practical-example-from-scratch-7)
  - [\\ (Backslash)](#-backslash)
    - [Practical Example from Scratch](#-practical-example-from-scratch-8)

### 🌊 Streams and Redirection
- [Streams and Redirection Commands](#-streams-and-redirection-commands)
  - [Redirecting Output (`>` and `>>`)](#redirecting-output--and-)
    - [Practical Example (Overwrite vs. Append)](#-practical-example-overwrite-vs-append)
  - [Redirecting Input (`<`)](#redirecting-input-)
    - [Practical Example](#-practical-example-8)
  - [Advanced Redirection: Working with `stderr`](#advanced-redirection-working-with-stderr)
    - [The Bit Bucket: `/dev/null`](#the-bit-bucket-devnull)
    - [Practical Example (Separating `stdout` and `stderr`)](#-practical-example-separating-stdout-and-stderr)
  - [Merging Streams (`2>&1`)](#merging-streams-21)
    - [Practical Example (The *Correct* Way)](#-practical-example-the-correct-way)
    - [Practical Example (The *Wrong* Way)](#-practical-example-the-wrong-way)
  - [Suppressing Error Messages](#suppressing-error-messages)
    - [Practical Example](#-practical-example-9)

### 🌀 Metacharacters and Patterns
- [Metacharacters and Character Classes](#-metacharacters-and-character-classes)
  - [Metacharacter Definitions](#-metacharacter-definitions)
  - [Digits and Characters (Character Classes)](#-digits-and-characters-character-classes)
  - [Filenames and Metacharacters (Globbing in Practice)](#️-filenames-and-metacharacters-globbing-in-practice)
    - [Practical Example: Globbing with `ls`](#-practical-example-globbing-with-ls)
    - [Special Cases](#special-cases)
      - [No Match Found](#no-match-found)
      - [The `~` (Tilde) Metacharacter](#the--tilde-metacharacter)
